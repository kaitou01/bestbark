...
class ProductsController < ApplicationController
  ...
  before_action :load_shopping_cart, only: %I[show load_shopping_cart generate_invoice]
  ...
  def generate_invoice
    ...
    session[:customer_info] = { name: name, address: address, city: city,
                                province: province_id, postal: postal }
  ...
  def add_to_cart
    ...
    session[:products_to_buy] << product_hash
